...
export default class App extends React.Component {
  ...
  toggleCompleted(todoId) {
    ...
    const indexNumber = stateToDos.findIndex(element => element.todoId === todoId);
    const status = stateToDos[indexNumber].isCompleted ? { isCompleted: false } : { isCompleted: true };
    fetch(`http:/api/todos/${todoId}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
      ...
      .then(response => response.json())
      .then(data => {
        const newData = [...stateToDos];
        newData[indexNumber] = data;
